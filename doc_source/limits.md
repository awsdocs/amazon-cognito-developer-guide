...
| --- | --- | 
| Read user profileExamples: `AdminInitiateAuth`, `GetUser`, `GetDevice` | 10 | 
| Write user profileExamples: `UpdateUserAttributes`, `SetUserSettings`, `AdminLinkProviderForUser` | 10 | 
