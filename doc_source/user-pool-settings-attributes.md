...
**phone**  
A phone number is required if SMS multi\-factor authentication \(MFA\) is enabled\. For more information, see [Adding MFA to a user pool](user-pool-settings-mfa.md)\.  
