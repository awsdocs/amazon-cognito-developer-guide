...
+ [Code examples for Amazon Cognito Identity Provider using AWS SDKs](service_code_examples.md)
   + [Code examples for Amazon Cognito Identity Provider using AWS SDKs](service_code_examples_cognito-identity-provider.md)
      + [Actions for Amazon Cognito Identity Provider using AWS SDKs](service_code_examples_cognito-identity-provider_actions.md)
         + [Confirm an Amazon Cognito user using an AWS SDK](example_cognito-identity-provider_ConfirmSignUp_section.md)
         + [Confirm an MFA device for tracking by Amazon Cognito using an AWS SDK](example_cognito-identity-provider_ConfirmDevice_section.md)
         + [Delete an Amazon Cognito user using an AWS SDK](example_cognito-identity-provider_DeleteUser_section.md)
         + [Get a token to associate an MFA application with an Amazon Cognito user using an AWS SDK](example_cognito-identity-provider_AssociateSoftwareToken_section.md)
         + [Get information about an Amazon Cognito user using an AWS SDK](example_cognito-identity-provider_AdminGetUser_section.md)
         + [List the Amazon Cognito user pools using an AWS SDK](example_cognito-identity-provider_ListUserPools_section.md)
         + [List Amazon Cognito users using an AWS SDK](example_cognito-identity-provider_ListUsers_section.md)
         + [Resend an Amazon Cognito confirmation code using an AWS SDK](example_cognito-identity-provider_ResendConfirmationCode_section.md)
         + [Respond to Amazon Cognito SRP authentication challenges using an AWS SDK](example_cognito-identity-provider_RespondToAuthChallenge_section.md)
         + [Respond to an Amazon Cognito authentication challenge using an AWS SDK](example_cognito-identity-provider_AdminRespondToAuthChallenge_section.md)
         + [Sign up a user with Amazon Cognito using an AWS SDK](example_cognito-identity-provider_SignUp_section.md)
         + [Start authentication with a device tracked by Amazon Cognito using an AWS SDK](example_cognito-identity-provider_InitiateAuth_section.md)
         + [Start authentication with Amazon Cognito and administrator credentials using an AWS SDK](example_cognito-identity-provider_AdminInitiateAuth_section.md)
         + [Verify an MFA application with an Amazon Cognito user using an AWS SDK](example_cognito-identity-provider_VerifySoftwareToken_section.md)
      + [Scenarios for Amazon Cognito Identity Provider using AWS SDKs](service_code_examples_cognito-identity-provider_scenarios.md)
         + [Sign up a user with an Amazon Cognito user pool that requires MFA using an AWS SDK](example_cognito-identity-provider_Scenario_SignUpUserWithMfa_section.md)
   + [Code examples for Amazon Cognito Identity using AWS SDKs](service_code_examples_cognito-identity.md)
      + [Actions for Amazon Cognito Identity using AWS SDKs](service_code_examples_cognito-identity_actions.md)
         + [Create a new Amazon Cognito Identity with a specified name](example_cognito-identity_CreateIdentityPool_section.md)
         + [List Amazon Cognito Identity pools](example_cognito-identity_ListIdentityPools_section.md)
      + [Cross-service examples for Amazon Cognito Identity using AWS SDKs](service_code_examples_cognito-identity_cross-service_examples.md)
   ...
   + [Code examples for Amazon Cognito Sync using AWS SDKs](service_code_examples_cognito-sync.md)
      + [Actions for Amazon Cognito Sync using AWS SDKs](service_code_examples_cognito-sync_actions.md)
         + [Get a list of identity pools registered with Amazon Cognito using an AWS SDK](example_cognito-sync_ListIdentityPoolUsage_section.md)
+ [Amazon Cognito identity pools (federated identities)](cognito-identity.md)
   ...
   + [Using identity pools (federated identities)](identity-pools.md)
      + [Using Amazon Cognito Sync with identity pools](identity-pools-sync.md)
